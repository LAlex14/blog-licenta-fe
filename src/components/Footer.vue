...
const navigation = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/lesan.alexandru/',
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/lesan.a/',
    icon: defineComponent({
      render: () =>
        h('svg', {fill: 'currentColor', viewBox: '0 0 24 24'}, [
          h('path', {
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/lesan_a',
    icon: defineComponent({
      render: () =>
        h('svg', {fill: 'currentColor', viewBox: '0 0 24 24'}, [
          h('path', {
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/alexandru-leșan/',
    icon: defineComponent({
      render: () =>
        h('svg', {fill: 'currentColor', viewBox: '0 0 24 24'}, [
          h('path', {
